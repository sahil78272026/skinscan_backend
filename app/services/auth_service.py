...
class AuthService:
    ...
    def process_email_login(self, email: str, consent_analysis: bool) -> tuple[User, str]:
    ...
    def process_google_login(self, token: str, client_id: str, consent_analysis: bool) -> tuple[User, str]:
        ...
        try:
            ...
            email = idinfo['email']
            return self.process_email_login(email, consent_analysis)
        except ValueError:
